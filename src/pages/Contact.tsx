    ...
    <div className="mx-auto max-w-4xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2">
        <div className="flex flex-col items-center rounded-3xl bg-neutral-50 p-8 text-center ring-1 ring-neutral-100">
          ...
          <h3 className="mt-4 text-lg font-bold text-neutral-900">Chat on WhatsApp</h3>
          <p className="mt-1.5 text-sm text-neutral-500">Fastest way to reach us about a design.</p>
          <a
            href={getWhatsAppLink()}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-5 inline-flex items-center gap-2 rounded-full bg-[#25D366] px-6 py-3 text-sm font-bold text-white shadow transition hover:brightness-95"
          >
            Start Chat
          </a>
        </div>
        ...
        <div className="flex flex-col items-center rounded-3xl bg-neutral-50 p-8 text-center ring-1 ring-neutral-100">
          ...
          <h3 className="mt-4 text-lg font-bold text-neutral-900">Message on Facebook</h3>
          <p className="mt-1.5 text-sm text-neutral-500">Visit our page for updates and messages.</p>
          <a
            href={getFacebookLink()}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-5 inline-flex items-center gap-2 rounded-full bg-blue-800 px-6 py-3 text-sm font-bold text-white shadow transition hover:brightness-110"
          >
            Facebook Page
          </a>
        </div>
      ...
      <div className="mt-10 grid gap-4 rounded-3xl bg-white p-8 text-center ring-1 ring-neutral-100 sm:grid-cols-3">
        ...
        <div>
          <p className="text-xs font-bold uppercase tracking-widest text-neutral-400">Studio</p>
